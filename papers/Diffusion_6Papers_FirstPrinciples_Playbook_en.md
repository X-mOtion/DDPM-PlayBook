...
- Citation: `Ref: [P?, p.?]` at the end of each entry title indicates the source; `p.?` corresponds to the page number of the paper PDF (aligned with the `=== PAGE ? ===` tags of `papers/text/*.txt`).
